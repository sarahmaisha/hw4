		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' )) {	// Check for a-z,  Changed so that it deleted the checking for 0-9
					nextState = 1;
			...
			case 1: 
				...
				// . -> State 2
				else if ((currentChar == '.') || (currentChar == '-') || (currentChar == '_')) { // Changed so that could add - and _
					nextState = 2;
